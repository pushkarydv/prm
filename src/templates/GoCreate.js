      ...
      <div className="text-center py-12 lg:py-24">
        ...
        <div className="pt-16 flex flex-col md:flex-row justify-center gap-4 items-center">
          {[
            ...
            <Link
              className="no-underline w-52 text-center transition p-8 border-slate-200 border-2 rounded-lg cursor-pointer hover:scale-105 hover:shadow-lg hover:shadow-slate-200  hover:-rotate-3 hover:bg-slate-100"
              key={name}
              to={to}
            >
